...
|----------|--------|------------|
| SiteDetector определяет pari | ✅ | site: "Pari" |
| Сбор операций | ✅ | 200 операций собрано |
| Группировка | ✅ | 103 группы (97 ставок + 6 депозитов) |
| Загрузка деталей | ✅ | 97/97 (100%) |
| Экспорт JSON | ✅ | site: "Pari", все поля корректны |
| regId заполнен | ✅ | Через fallback: details.header.regId / marker |
| UI панель | ✅ | "Pari Collector v2.0.0" |
| Консольный доступ | ✅ | window.collector |
...
### Pari (2026-02-08, v2.0.0)

**Тестировщик:** Claude Code + анализ экспортированного JSON
**Тестовый аккаунт:** pari.ru (с историей операций)

**Результаты:**
- Все проверки пройдены
- SiteDetector: корректно определяет pari
- Экспорт: site: "Pari", все поля заполнены
